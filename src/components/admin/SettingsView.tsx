...
const SettingsView: React.FC<SettingsViewProps> = ({ services, setServices }) => {
    ...
    const handleUpdateService = async (e: React.FormEvent) => {
        ...
        if (editingService && newServiceName.trim()) {
            ...
            if (data) {
                setServices(services.map((s: any) => s.id === data.id ? data : s));
                cancelEditService();
            }
        }
    };
    ...
    const handleDeleteColab = async (id: string) => {
        ...
        setColabs(colabs.filter((c: any) => c.id !== id));
    };
                    ...
                    >
                        ...
                        {activeTab === 'general' && (
                            <div>
                                ...
                                <form onSubmit={editingService ? handleUpdateService : handleAddService} className="grid grid-cols-1 md:grid-cols-12 gap-4 mb-8 rounded-2xl p-6" style={{ background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.05)' }}>
                        ...
                        {activeTab === 'products' && (
                            <div>
                                ...
                                <form onSubmit={handleAddProduct} className="grid grid-cols-1 md:grid-cols-12 gap-4 mb-8 rounded-2xl p-6" style={{ background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.05)' }}>
                                    <div className="md:col-span-4">
                        ...
                        {activeTab === 'colabs' && (
                            <div>
                                ...
                                <form onSubmit={handleAddColab} className="flex flex-col md:flex-row gap-4 mb-8 rounded-2xl p-6" style={{ background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.05)' }}>
                                    <div className="flex-1">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    {colabs.map((colab: any) => (
                                        <motion.div
                                            ...
                                            style={{ background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.05)' }}
                                        >
                                            <div className="w-16 h-16 rounded-lg flex items-center justify-center border p-2" style={{ background: 'rgba(0,0,0,0.4)', borderColor: 'rgba(255,255,255,0.1)' }}>
                                                {colab.logo_url ? (
